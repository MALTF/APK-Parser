...
import com.malt.parser.bean.AdaptiveIcon
import com.malt.parser.bean.ApkMeta
import com.malt.parser.bean.ApkSignStatus
import com.malt.parser.bean.ApkSigner
import com.malt.parser.bean.ApkV2Signer
import com.malt.parser.bean.CertificateMeta
import com.malt.parser.bean.DexClass
import com.malt.parser.bean.Icon
import com.malt.parser.bean.IconFace
import com.malt.parser.bean.IconPath
import com.malt.parser.exception.ParserException
import com.malt.parser.parser.AdaptiveIconParser
import com.malt.parser.parser.ApkMetaTranslator
import com.malt.parser.parser.ApkSignBlockParser
import com.malt.parser.parser.BinaryXmlParser
import com.malt.parser.parser.CertificateMetas
import com.malt.parser.parser.CertificateParser
import com.malt.parser.parser.CompositeXmlStreamer
import com.malt.parser.parser.DexParser
import com.malt.parser.parser.ResourceTableParser
import com.malt.parser.parser.XmlStreamer
import com.malt.parser.parser.XmlTranslator
import com.malt.parser.struct.AndroidConstants
...
import com.malt.parser.struct.zip.EOCD
...
abstract class AbstractApkFile : Closeable {
    ...
    private fun parseResourceTable() {
        ...
        if (data == null) {
            ...
            resourceTable = ResourceTable(stringPool = null)
        ...
        Log.d("resourceTable", "resourceTable:${resourceTable?.stringPool}")
